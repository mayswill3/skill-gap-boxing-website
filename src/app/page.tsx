        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Featured Fighter</h3>
              <div className="w-24 h-1 bg-red-600 mx-auto"></div>
            </div>
            
            <div className="bg-gradient-to-r from-gray-900 via-black to-gray-900 rounded-xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-300 group">
              <a href="/fighters/omari-grant" className="block">
                <div className="grid lg:grid-cols-2 gap-0">
                  <div className="relative h-96 lg:h-auto overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-black/20 to-transparent group-hover:from-black/10 transition-all duration-300"></div>
                ...
                <div className="p-8 lg:p-12 text-white">
                  <div className="mb-6">
                    <h4 className="text-3xl md:text-4xl font-bold mb-2 text-red-400">Omari Grant</h4>
                  ...
                  <p className="text-gray-300 leading-relaxed mb-8">
                    An influencer boxer and Music Artist who has had a total of 19 bouts and 9 title wins. He is a public figure straight out of Nottingham. A community worker who has been awarded for his contribution with working with youths and people with disabilities through the art of boxing. A flamboyant and exciting character in the ring and an ambassador for the sport outside of it. Whether it is on the stage or in the ring or in the classroom, he is known to do his best and in the process help others as well.
                  </p>
                  
                  <div className="grid grid-cols-2 gap-6">
                    <div className="text-center">
                      <div className="text-3xl font-bold text-red-400">19</div>
                      <div className="text-gray-400 text-sm">Total Bouts</div>
                    </div>
                    <div className="text-center">
                      <div className="text-3xl font-bold text-red-400">9</div>
                      <div className="text-gray-400 text-sm">Title Wins</div>
                    </div>
                  </div>
                  
                  <div className="mt-6 flex flex-wrap gap-2">
                    <span className="bg-red-600 text-white px-3 py-1 rounded-full text-sm font-semibold">Influencer Boxer</span>
                    <span className="bg-gray-700 text-white px-3 py-1 rounded-full text-sm">Music Artist</span>
                    <span className="bg-gray-700 text-white px-3 py-1 rounded-full text-sm">Community Worker</span>
                    <span className="bg-gray-700 text-white px-3 py-1 rounded-full text-sm">Nottingham</span>
                  </div>
                  ...
                  <div className="mt-6 flex items-center gap-4">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 transform hover:scale-105"
                    >
